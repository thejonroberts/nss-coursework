...
},{"../templates/partials/header.hbs":23,"../templates/solarSystem.hbs":24,"../templates/test.hbs":25,"hbsfy/runtime":21,"jquery":22}],2:[function(require,module,exports){
'use strict';
...
module.exports = HandlebarsCompiler.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<h1>the Solar System (abbr)</h1>\n"
    + ((stack1 = container.invokePartial(partials.nav,depth0,{"name":"nav","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + "<ul>\n"
    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.planets : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "</ul>\n<h2>This is 2 + 2: "
    + container.escapeExpression(((helper = (helper = helpers.add || (depth0 != null ? depth0.add : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(alias1,{"name":"add","hash":{},"data":data}) : helper)))
    + "</h2>";
...
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<p>I'm from teh template!</p>";
},"useData":true});
